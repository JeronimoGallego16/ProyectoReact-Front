          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/usuarios"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/usuarios' &&
              ...
              <li>
                <NavLink
                  to="/grupos"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/grupos' &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                  ...
                  >
                    <path
                      d="M9 2.25C5.02031 2.25 1.875 5.39531 1.875 9.375C1.875 13.3547 5.02031 16.5 9 16.5C12.9797 16.5 16.125 13.3547 16.125 9.375C16.125 5.39531 12.9797 2.25 9 2.25ZM9 15C5.51016 15 2.75 12.2398 2.75 8.75C2.75 5.26016 5.51016 2.5 9 2.5C12.4898 2.5 15.25 5.26016 15.25 8.75C15.25 12.2398 12.4898 15 9 15Z"
                      fill=""
                    />
                    <path
                      d="M9 5.5C8.47969 5.5 8 5.96484 8 6.5C8 7.03516 8.47969 7.5 9 7.5C9.52031 7.5 10 7.03516 10 6.5C10 5.96484 9.52031 5.5 9 5.5Z"
                      fill=""
                    />
                    <path
                      d="M6.5 10C5.97969 10 5.5 10.4648 5.5 11C5.5 11.5352 5.97969 12 6.5 12C7.02031 12 7.5 11.5352 7.5 11C7.5 10.4648 7.02031 10 6.5 10Z"
                      fill=""
                    />
                    <path
                      d="M11.5 10C10.9797 10 10.5 10.4648 10.5 11C10.5 11.5352 10.9797 12 11.5 12C12.0203 12 12.5 11.5352 12.5 11C12.5 10.4648 12.0203 10 11.5 10Z"
                      fill=""
                    />
                  </svg>
                   Grupos
              ...
              <li>
                <NavLink
                  to="/carreras"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/carreras' &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/matricula"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/matricula' &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
