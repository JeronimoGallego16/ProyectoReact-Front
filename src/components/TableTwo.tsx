import PlaceholderProduct from '../images/placeholder.svg';

const ProductOne = PlaceholderProduct;
const ProductTwo = PlaceholderProduct;
const ProductThree = PlaceholderProduct;
const ProductFour = PlaceholderProduct;
